...
class microsoft_dependency_handler implements pts_dependency_handler
{
	public static function startup_handler()
	{
		...
		if(!is_file('C:\cygwin64\bin\bash.exe') || !is_file('C:\cygwin64\bin\unzip.exe') || !is_file('C:\cygwin64\bin\which.exe'))
		{
			...
			echo PHP_EOL . 'Configuring Cygwin for handling of some portable test scripts, extracting .tar.gz/xz files, and other script helpers... More details on the Phoronix Test Suite for Windows @ https://github.com/Eddict/phoronix-test-suite/blob/master/documentation/ ' . PHP_EOL;
