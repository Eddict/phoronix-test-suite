...
class phoromatic_caches implements pts_webui_interface
{
	...
	public static function render_page_process($PATH)
	{
		...
		{
			$main .= '<h3>No download cache file could be found; on the Phoromatic Server you should run <strong>phoronix-test-suite make-download-cache</strong>. See the <a href="https://github.com/Eddict/phoronix-test-suite/tree/master/documentation">documentation</a> for more information on download-cache setup.</h3>'; // TODO XXX implement from the GUI
		}
